...
public class ProductDtoPriceInfo {
  ...
  public ProductDtoPriceInfo() {
  }

  public ProductDtoPriceInfo currencyCode(String currencyCode) {
  ...
  **/
  ...
  public ProductDtoPriceInfo price(Float price) {
  ...
  **/
  ...
  public ProductDtoPriceInfo originalPrice(Float originalPrice) {
  ...
  **/
  ...
  public ProductDtoPriceInfo cost(Float cost) {
  ...
  **/
  ...
  public ProductDtoPriceInfo priceEffectiveTime(PriceInfoPriceEffectiveTime priceEffectiveTime) {
  ...
  **/
  ...
  public ProductDtoPriceInfo priceExpireTime(PriceInfoPriceExpireTime priceExpireTime) {
  ...
  **/
  ...
  public ProductDtoPriceInfo priceRange(PriceInfoPriceRange priceRange) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductDtoPriceInfo productDtoPriceInfo = (ProductDtoPriceInfo) o;
    return Objects.equals(this.currencyCode, productDtoPriceInfo.currencyCode) &&
        Objects.equals(this.price, productDtoPriceInfo.price) &&
        Objects.equals(this.originalPrice, productDtoPriceInfo.originalPrice) &&
        Objects.equals(this.cost, productDtoPriceInfo.cost) &&
        Objects.equals(this.priceEffectiveTime, productDtoPriceInfo.priceEffectiveTime) &&
        Objects.equals(this.priceExpireTime, productDtoPriceInfo.priceExpireTime) &&
        Objects.equals(this.priceRange, productDtoPriceInfo.priceRange);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProductDtoPriceInfo
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductDtoPriceInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductDtoPriceInfo is not found in the empty JSON string", ProductDtoPriceInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductDtoPriceInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductDtoPriceInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductDtoPriceInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductDtoPriceInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductDtoPriceInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductDtoPriceInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductDtoPriceInfo>() {
           @Override
           public void write(JsonWriter out, ProductDtoPriceInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductDtoPriceInfo read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProductDtoPriceInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductDtoPriceInfo
  * @throws IOException if the JSON string is invalid with respect to ProductDtoPriceInfo
  */
  public static ProductDtoPriceInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductDtoPriceInfo.class);
  }

 /**
  * Convert an instance of ProductDtoPriceInfo to an JSON string
  *
  * @return JSON string
  */
