...
public class FulfillmentInfo {
  ...
  public FulfillmentInfo type(String type) {
  ...
  **/
  ...
  public FulfillmentInfo placeIds(List<String> placeIds) {
    
    this.placeIds = placeIds;
    return this;
  }

  public FulfillmentInfo addPlaceIdsItem(String placeIdsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, fulfillmentInfo.type) &&
        Objects.equals(this.placeIds, fulfillmentInfo.placeIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, placeIds);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to FulfillmentInfo
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FulfillmentInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FulfillmentInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FulfillmentInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
